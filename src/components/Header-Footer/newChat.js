      ...
      <div>
        <div className="dropdown">
          ...
          <div
            ...
            style={{ marginLeft: "-480%", width: "100px", height: "150px" }}
          >
            <div>
              <p>
                <Link
                  to="#"
                  onClick={() => this.showBox("Ajeet")}
                  style={{ color: "black" }}
                >
                  Ajeet
                </Link>{" "}
          ...
          {this.state.showBox ? (
            <div className="msg_box" style={{ right: "270px" }}>
              ...
              <div style={hidden} className="msg_wrap">
                ...
                <div className="msg_body" style={{ height: "70px" }}>
                  <Link to="#" style={{ color: "#ff5200" }}>
                    <h6>
