    ...
    <nav className="toolbar_navigation">
        ...
        <div className="dropdown-content">
          <div>
            ...
            <p style={{ marginTop: "13px" }}>
              <Link className="links" to="/attendencef">
                Attendance
              </Link>
            </p>
            <p>
              <Link className="links" to="/timetablef">
                Time Table
              </Link>
            </p>
            <p>
              <Link className="links" to="/examf">
                About Exam
              </Link>
            </p>
            <p>
              <Link className="links" to="/salaryf">
                Salary Details
              </Link>
            </p>
          </div>
      ...
      <div className="dropdown">
        ...
        <div className="dropdown-content">
          <div>
            <div id="triangle-up"></div>
            <p style={{ marginTop: "13px" }}>
              <Link className="links" to="/assignmentf">
                Assignment
              </Link>
            </p>
            <p>
              <Link className="links" to="/projectf">
                Projects
              </Link>
            </p>
            <p>
              <Link className="links" to="/studyf">
                Study Material
              </Link>
            </p>
            <p>
      ...
      <div className="dropdown">
        <Link style={{ color: "white" }} to="/profile">
          <FontAwesomeIcon
            icon={faUser}
            style={{ marginRight: "0.25em", textDecoration: "none" }}
          />{" "}
          Profile
        </Link>
      </div>
