...
export default class Project extends Component {
    ...
    render() {
        ...
        return (
            <div className="project" style={{marginLeft:'22%',marginRight:'22%', marginBottom:'13%'}}>
                        ...
                        <form onSubmit={this.handlesubmit}>
                            ...
                            <label style={{margin:'0px', width:'100%'}}>Project Link*</label><br></br>
                                <div className="form-group" style={{display:'inline'}}>
                                    ...
                                    <div style={{textAlign:"center", paddingTop:'3px',paddingBottom:'5px'}}>or</div>
                                    <input style={{width:'100%'}} id="chooseFile" type="file" value={this.state.chooseFile}
                                        onChange={this.handlechooseFile} required />
                                </div>
                            <Button style={{ margin:'auto',marginTop:'20px', display:'block', paddingTop:'10px'}} onClick={() =>this.setState({ addProject: true })}>+ Add Project</Button>
                        </form>
                    </div>
                    <Addproject
