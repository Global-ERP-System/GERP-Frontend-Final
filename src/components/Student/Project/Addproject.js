            ...
            <div>
                <Modal
                    ...
                    <Modal.Header closeButton>
                        <Modal.Title id="contained-modal-title-vcenter" className="Add_ProjectHeading" style={{fontFamily:'Montserrat ', fontWeight:'700'}}>
                    ...
                    <Modal.Body style={{background:'whitesmoke'}}>
                            ...
                            <div className="Add_Project_container">
                                <form onSubmit={this.handlesubmit}>
                                    ...
                                    <label  style={{fontFamily:'Pt sans narrow ', fontWeight:'700'}}>Description</label>
                                    ...
                                    <label  style={{fontFamily:'Pt sans narrow ', fontWeight:'700'}}>Project Link*</label>
