      ...
      <div className="cont">
        ...
        <form onSubmit={this.handlesubmit} style={{ marginTop: "0px" }}>
          <Row>
            <Col sm={5}>
              <label
                style={{ fontFamily: "Pt sans narrow ", fontWeight: "700" }}
              >
                Name:
              </label>
            </Col>
          ...
          <div>
            <Row>
              <Col sm={5}>
                <p style={{ fontFamily: "Pt sans narrow ", fontWeight: "700" }}>
                  {" "}
                  Previous Fee Status:&nbsp;&nbsp;&nbsp;
                </p>
              </Col>
              <Col sm={7}>
                <input
                  className="form-control"
                  value={this.state.Previousfeestatus}
                  onChange={this.handlePreviousfeestatus}
                  required
                  style={{
            ...
            <Row>
              ...
              <Col sm={7}>
                <input
                  className="form-control"
                  value={this.state.duefeestatus}
                  onChange={this.handleduefeestatus}
                  required
                  style={{
                    fontFamily: "Montserrat Regular",
                    fontWeight: "400",
            ...
            <Row>
              ...
              <Col sm={7}>
                <input
                  className="form-control"
                  value={this.state.duefeeamount}
                  onChange={this.handleduefeeamount}
                  required
                  style={{
                    fontFamily: "Montserrat Regular",
                    fontWeight: "400",
            ...
            <Row>
              ...
              <Col sm={7}>
                <input
                  className="form-control"
                  value={this.state.lastdateforpayment}
                  onChange={this.handlelastdateforpayment}
                  required
                  style={{
                    fontFamily: "Montserrat Regular",
                    fontWeight: "400",
          ...
          <div className="Display_Button">
            ...
            <button id="Pay" type="submit" className="btn">
              Pay
            </button>
          </div>
        </form>
        ...
        <div id="year1">
          ...
          <div className="SearchPeople">
            {" "}
            <button
              style={{ color: "white", backgroundColor: "#25a0f7" }}
              type="submit"
              className="btn"
            >
              View Receipt
        ...
        <div id="year1">
          ...
          <div className="SearchPeople">
            <button
              id="connectdecline"
              style={{ backgroundColor: "green", marginTop: "6%" }}
            >
              Pay Now
            </button>
          </div>
