    ...
    render() {
        return (
            <div id="main">
                ...
                <div id="SideNavBar" style={{width:'18%',marginTop:'17.6%'}}>
                ...
                <div id="Contentbox"style={{height:'316px',marginRight:'-135px',marginTop:'-60px', marginLeft:'20%'}}>
                    <h3 className="Community"style={{fontSize:'28px',padding:'2px'}}>Faculty Community Forum</h3>
                    ...
                    <div id="newRecent" >
                        ...
                        <div id="designation"><b>Mr. Sumit Goel</b>
                        <p style={{width:'120%',marginLeft:'-13%'}}>IIT Delhi, Delhi<br></br>
                        <span style={{marginLeft:'-29%',color:'green'}}>10h</span>
                        </p> 
...
{/* 
                ...
                <div id="SideNavBar" style={{width:'18%',marginLeft:'81%',marginTop:'17.6%'}}>
                    {/* <FontAwesomeIcon icon={faCalendarCheck} size="3x" style={{margin:'3% 7%'}}></FontAwesomeIcon>
                    ...
                    <p style={{margin:'13% 20%'}}>Monday class at 3PM</p> */}
                        ...
                        <img src="https://almashines.s3.dualstack.ap-southeast-1.amazonaws.com/assets/images/cover/487.jpg?v=1575095450" style={{height:'27%',width:'100%'}}></img>
                         ...
                         <p style={{margin:'-8% 8%'}}>Dec 2019- Present <span style={{color:'green',float:'right',fontSize:'12px',marginRight:'44px',marginTop:'5px'}}><li style={{marginLeft:'-10px'}}>8 mos</li></span></p>
                         <p style={{margin:'8% 8%',color:'blue'}}>
