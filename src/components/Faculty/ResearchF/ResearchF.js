...
const Research = (props) => {
  return (
    <div className={classes.Research}>
      <div>
        <h1>
          No research is ever quite complete. It is the glory of a good bit of
          work that it opens the way for something still better, and this
          repeatedly leads to its own eclipse.
        </h1>
        <h2> - Mervin Gordon </h2>
        <form>
