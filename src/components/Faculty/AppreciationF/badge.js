...
export default class BadgeClass extends React.Component {
  ...
  render() {
    return (
  <div>
  <svg onClick={() => alert("This badge gets displayed to student")} className="badge" xmlns="http://www.w3.org/2000/svg" height="100" width="100" viewBox="-40 -40 440 440">
      <circle className="outer" fill="#F9D535" stroke="#fff" stroke-width="8" stroke-linecap="round" cx="180" cy="180" r="157"/>
