               ...
               <br/><br/>
                <CardBody >                	                	
	                ...
	                <form className="form-group">  
                        ...
                        <input className="form-control" type="text" name="roll" style={{width:"75%",margin:'0'}} 
                        placeholder="Enter student roll number" /><br/>
		                <label>Appreciation Message: </label><br/>
		                <textarea className="form-control" placeholder="Message" style={{width:"75%"}}></textarea><br/>	
