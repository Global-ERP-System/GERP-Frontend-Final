...
import { Container, Row, Col, Button,NavLink, Card, CardTitle, CardBody} from 'reactstrap';
    ...
    render()  {
        return (
            ...
            <Card>
                ...
                <div style={{marginLeft:"30%",width:"40%",alignContent:"center"}}>
                    <MDBFormInline >
                        <Col style={{textAlign:"left",width:"50%"}} className="column">Full Name</Col>
                        <Col style={{marginLeft:"20%"}} className="column">{this.state.fullName}</Col>
                    </MDBFormInline>
                    <MDBFormInline>
                        <Col style={{textAlign:"left",width:"50%"}} className="column">Address</Col>
                        <Col style={{marginLeft:"20%"}} className="column">{this.state.address}</Col>
                    </MDBFormInline>
                    <MDBFormInline>
                        <Col style={{textAlign:"left",width:"50%"}} className="column">Registration Number</Col>
                        <Col style={{marginLeft:"20%"}} className="column">{this.state.registrationNumber}</Col>
                    </MDBFormInline>
                    <MDBFormInline>
                        <Col style={{textAlign:"left",width:"50%"}} className="column">Phone Number</Col>
                        <Col style={{marginLeft:"20%"}} className="column">{this.state.phoneNumber}</Col>
                    </MDBFormInline>
                    <MDBFormInline>
                        <Col style={{textAlign:"left",width:"50%"}} className="column">Blood Group</Col>
                        <Col style={{marginLeft:"20%"}} className="column">{this.state.bloodGroup}</Col>
                    </MDBFormInline>
                    <MDBFormInline>
                        <Col style={{textAlign:"left",width:"50%"}} className="column">Campus Code</Col>
                        <Col style={{marginLeft:"20%"}} className="column">{this.state.campusCode}</Col>
                    </MDBFormInline>
                    <MDBFormInline>
                        <Col style={{textAlign:"left",width:"50%"}} className="column">E-mail Id</Col>
                        <Col style={{marginLeft:"20%"}} className="column">{this.state.email}</Col>
                    </MDBFormInline>
                </div>
                </div>

                <div id="button" style={{textAlign:"left"}}>


                <Popup className='popup' trigger={<button style={{marginLeft: "35%", fontSize: "15px"}}><b style={{color:'white'}}>Enter Campus Code</b></button>} position="right bottom">
