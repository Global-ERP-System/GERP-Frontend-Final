...
import { Table, Dropdown, DropdownToggle, DropdownMenu, DropdownItem, Button, Row, Col } from 'reactstrap';
import './leaves.css'
            ...
            <React.Fragment>
                <div className="leavebody">
                    ...
                    <Col sm={7}>
                        ...
                        <Col sm={3}> 
                            <center>
                            <Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggle} className="yeardropdown">
                    ...
                    <button style={{ color: "white", backgroundColor: '#138808' }} id="buttonforleave" type="submit" className="btn">Apply for Leave</button> 
                </div>
            </React.Fragment>
        )
    }
